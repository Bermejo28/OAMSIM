  ...
  const sendMessage = async (e) => {
    ...
    setTimeout(() => {
      const automatedMsg = {
        application_id: applicationId,
        sender: 'system',
        message: "Thank you for reaching out. The administrator is currently unavailable. For inquiries, visit the FAQ page. For assistance, refer to ptcoams.help.support.",
